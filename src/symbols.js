...
// Capabilities
export const $CanBeEmbedded = Symbol('%CanBeEmbedded');
export const $CanBeReferenced = Symbol('%CanBeReferenced');
export const $CanContainReferences = Symbol('%CanContainReferences');
